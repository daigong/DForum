...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topic.qvod_address'
        db.delete_column('lbforum_topic', 'qvod_address')

        # Adding field 'Post.qvod_address'
        db.add_column('lbforum_post', 'qvod_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Topic.qvod_address'
        db.add_column('lbforum_topic', 'qvod_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Post.qvod_address'
        db.delete_column('lbforum_post', 'qvod_address')
    ...
    models = {
        ...
        'lbforum.post': {
            ...
            'qvod_address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'lbforum.topic': {
            ...
            'has_attachments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_imgs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_qvod': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
