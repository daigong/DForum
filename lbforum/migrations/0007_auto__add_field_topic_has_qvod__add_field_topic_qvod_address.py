...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.has_qvod'
        db.add_column('lbforum_topic', 'has_qvod',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.qvod_address'
        db.add_column('lbforum_topic', 'qvod_address',
                      self.gf('django.db.models.fields.CharField')(default=20130805, max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.has_qvod'
        db.delete_column('lbforum_topic', 'has_qvod')
    ...
    models = {
        ...
        'lbforum.topic': {
            ...
            'posted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'qvod_address': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
