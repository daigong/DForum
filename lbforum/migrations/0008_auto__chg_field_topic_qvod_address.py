...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.qvod_address'
        db.alter_column('lbforum_topic', 'qvod_address', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Topic.qvod_address'
        db.alter_column('lbforum_topic', 'qvod_address', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))
